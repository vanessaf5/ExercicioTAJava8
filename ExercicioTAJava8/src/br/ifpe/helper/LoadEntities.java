...
import br.ifpe.entities.Address;
...
public class LoadEntities {
	...
	private static void createDummyClient(int index) {
		...
		Client client = new Client("client"+Integer.toString(index), "client" + index + "@bank.com", ADDRESSES.get(addressPosition));
